...
public abstract class Link {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Link must be in URL Format, (https://something.something/something). Example: https://github.com/AY2021S1-CS2103T-F12-4/tp/issues/166";
